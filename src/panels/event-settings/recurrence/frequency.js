 ...
 *
 * Renders the frequency select (Daily/Weekly/Monthly) and the "repeat every"
 * interval number input. Clamping the interval to `Rule::MAX_INTERVAL` (52)
 * is the caller's responsibility, since the clamp also has to apply when the
 * value round-trips through the recurrence blob.
 *
 * @since 0.36.0
 *
 * @param {Object}   props                   Component props.
 * @param {string}   props.frequency         Current frequency value, one of `daily`, `weekly`, `monthly`.
